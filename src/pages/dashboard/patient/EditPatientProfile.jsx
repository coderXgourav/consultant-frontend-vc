...
//     axios
//       .get(`${import.meta.env.VITE_API_URL}/patient/get-single-patient/${id}`, {
//         headers: {
...
//     axios
//       .put(
//         `${import.meta.env.VITE_API_URL}/patient/update-patient/${id}`,
//         data,
//         {
//           headers: {
...
const EditPatientProfile = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(`${import.meta.env.VITE_API_URL}/patient/update-patient/${id}`, data, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
        },
      ...
      .then((response) => {
        openNotification(true, "Success", "Profile updated successfully");
        if (response.data.data.profilePhoto) {
          setFormData((prev) => ({
            ...prev,
            profilePhoto: response.data.data.profilePhoto,
